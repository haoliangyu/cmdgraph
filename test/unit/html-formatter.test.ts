...
describe('formatAsHtml', () => {
	...
	it('supports custom html title and readme section', () => {
		const root: CommandNode = {
			name: 'tool',
			description: 'A test command.',
			usage: 'tool [command]',
		...
		const html = formatAsHtml(root, {
			...
			readme: '# Generated by cmdgraph',
		})

		expect(html).toContain('<title>Custom Documentation Title</title>')
		expect(html).toContain('<h1>Generated by cmdgraph</h1>')
